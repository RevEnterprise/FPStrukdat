...
int main()
{
    ...
    int searchKey1 = 500000;
    cout << "\nSearching for key " << searchKey1 << ": "
         << (tree.search(searchKey1) ? "Found" : "Not Found")
         << endl;
    ...
    int searchKey2 = 900000;
    cout << "\nSearching for key " << searchKey2 << ": "
         << (tree.search(searchKey2) ? "Found" : "Not Found")
         << endl;
    ...
    std::cout << (tree.search(123) ? "Ada" : "Tidak Ada") << "\n";
    std::cout << (tree.search(1001) ? "Ada" : "Tidak Ada") << "\n"; // Harusnya Tidak Ada



        int keys[] = {1, 500000, 999999};
...
for (int i = 0; i < 3; i++) {
    ...
    // C++20: pastikan kompiler kamu mendukung std::chrono::picoseconds
    auto duration = std::chrono::duration_cast<std::chrono::picoseconds>(end - start);

    std::cout << "Searching for key " << key << ": "
              << (found ? "Found" : "Not Found")
              << " | Time taken: " << duration.count() << " picoseconds\n";
}
